...
export const metadata = {
  ...
  description:
    "Read the latest insights on AI, LLM development, and software engineering from the best software agency.",
};
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          Discover the latest trends in Artificial Intelligence, business
