  ...
  return (
    ...
    >
      ...
      <g fill="none" stroke="currentColor" strokeWidth="10" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="4">
        ...
        {/* R */}
        <g transform="translate(90,0)" className="kr-letter-wrapper">
          <g className="kr-letter-ghost" stroke="rgba(0,0,0,0.1)">
            <g clipPath="url(#c-r1)">
              <line x1="15" y1="10" x2="15" y2="90" />
              <path d="M 35 15 L 55 15 A 17 17 0 0 1 72 32 A 17 17 0 0 1 55 50 L 35 50 M 45 50 L 75 105" />
            </g>
          </g>
        ...
        {/* I */}
        <g transform="translate(180,0)" className="kr-letter-wrapper">
          <g className="kr-letter-ghost" stroke="rgba(0,0,0,0.1)">
            <g clipPath="url(#c-i)">
              <line x1="15" y1="10" x2="15" y2="90" />
            </g>
        ...
        {/* S */}
        <g transform="translate(220,0)" className="kr-letter-wrapper">
          <g className="kr-letter-ghost" stroke="rgba(0,0,0,0.1)">
            <g clipPath="url(#c-s)">
        ...
        {/* H */}
        <g transform="translate(310,0)" className="kr-letter-wrapper">
          <g className="kr-letter-ghost" stroke="rgba(0,0,0,0.1)">
            <g clipPath="url(#c-h)">
              <line x1="15" y1="10" x2="15" y2="90" />
        ...
        {/* O */}
        <g transform="translate(400,0)" className="kr-letter-wrapper">
          <g className="kr-letter-ghost" stroke="rgba(0,0,0,0.1)">
            <g clipPath="url(#c-o)">
        ...
        {/* R */}
        <g transform="translate(500,0)" className="kr-letter-wrapper">
          <g className="kr-letter-ghost" stroke="rgba(0,0,0,0.1)">
            <g clipPath="url(#c-r2)">
              <line x1="15" y1="10" x2="15" y2="90" />
              <path d="M 35 15 L 55 15 A 17 17 0 0 1 72 32 A 17 17 0 0 1 55 50 L 35 50 M 45 50 L 75 105" />
        ...
        {/* Λ */}
        <g transform="translate(590,0)" className="kr-letter-wrapper">
          <g className="kr-letter-ghost" stroke="rgba(0,0,0,0.1)">
            <g clipPath="url(#c-a)">
